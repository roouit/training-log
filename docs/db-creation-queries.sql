...
ALTER TABLE `user` MODIFY `username` VARCHAR(50) NOT NULL UNIQUE;
ALTER TABLE `user` MODIFY `email` VARCHAR(100) NOT NULL UNIQUE;

CREATE TABLE `exercise` (
`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
`exercise_name` VARCHAR(100) NOT NULL
);
ALTER TABLE `exercise` MODIFY `exercise_name` VARCHAR(100) NOT NULL UNIQUE;
